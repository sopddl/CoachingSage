...
src = pathlib.Path(
    ...
    "scratchpad/pictos_poc/prasarita_front_silhouette.png")
...
pose_desc = ("prasarita padottanasana seen from the front, facing the camera directly, "
             "standing with legs spread very wide apart in a wide V shape, "
             "torso folded forward and down, head hanging down near the floor between the arms, "
             "both hands reaching down to the floor between the legs, "
