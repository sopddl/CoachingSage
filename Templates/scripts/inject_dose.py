...
YOGA = {
    ...
    "3 min": S("3", "minutes"),
    "3.5 min de clôture": S("3.5", "minutes"),
    "3.5 min séquence": S("3.5", "minutes"),
    "4 min": S("4", "minutes"),
    "4 min de clôture semaine allégée": S("4", "minutes"),
    "4 min séquence": S("4", "minutes"),
    "4.5 min de clôture": S("4.5", "minutes"),
    "5 min": S("5", "minutes"),
    "5 min séquence": S("5", "minutes"),
    "5.5 min séquence": S("5.5", "minutes"),
    "5.5 min séquence de clôture": S("5.5", "minutes"),
    "6 min": S("6", "minutes"),
    "6 min de clôture": S("6", "minutes"),
    "6 min séquence": S("6", "minutes"),
    "6.5 min de clôture": S("6.5", "minutes"),
    "7 min": S("7", "minutes"),
    "8 min": S("8", "minutes"),
    "10 min": S("10", "minutes"),
    "12 min": S("12", "minutes"),
...
HIIT = {
    ...
    "1 min par round (work + repos auto-régulé)": F("1 min par tour (effort + repos auto-géré)", "1 min per round (work + self-paced rest)", "1 min por ronda (trabajo + descanso autorregulado)"),
    ...
    "20 m sled + 20 m farmer carry": F("20 m de poussée de traîneau + 20 m de port de charge (farmer carry)", "20 m sled + 20 m farmer carry", "20 m de sled + 20 m de farmer carry"),
    # --- RENFO membres (calf/tibialis/scapular/Y) -> freeText (noms gardés, /jambe traduit) ---
    "12 calf/jambe + 15 tibialis/jambe": F("12 extensions mollets par jambe + 15 relevés de tibial antérieur par jambe", "12 calf raises per leg + 15 tibialis raises per leg", "12 calf raises por pierna + 15 tibialis raises por pierna"),
    "12 calf/jambe + 15 tibialis/jambe + 12 scapular": F("12 extensions mollets par jambe + 15 relevés de tibial antérieur par jambe + 12 tractions scapulaires", "12 calf raises per leg + 15 tibialis raises per leg + 12 scapular pull-ups", "12 calf raises por pierna + 15 tibialis raises por pierna + 12 scapular pull-ups"),
    "15 calf/jambe + 18 tibialis/jambe": F("15 extensions mollets par jambe + 18 relevés de tibial antérieur par jambe", "15 calf raises per leg + 18 tibialis raises per leg", "15 calf raises por pierna + 18 tibialis raises por pierna"),
    "12 scapular + 12 Y-raise": F("12 tractions scapulaires + 12 Y-raise", "12 scapular pull-ups + 12 Y-raise", "12 scapular pull-ups + 12 Y-raise"),
    "12 Y + 12 face pull": F("12 Y + 12 face pull", "12 Y + 12 face pull", "12 Y + 12 face pull"),
    "15 tibialis + 12 scapular pull-up": F("15 relevés de tibial antérieur + 12 tractions scapulaires", "15 tibialis raises + 12 scapular pull-ups", "15 tibialis raises + 12 scapular pull-ups"),
    "12 squat + 8 push-up genoux": F("12 squats + 8 pompes sur les genoux", "12 squats + 8 knee push-ups", "12 squats + 8 push-up de rodillas"),
    ...
    "30 sec hollow + 30 sec V-ups": F("30 s de gainage hollow (hollow body) + 30 s de relevés en V", "30 s hollow + 30 s V-ups", "30 s de hollow + 30 s de V-ups"),
    "30 sec hollow rocks + 30 sec V-ups": F("30 s de gainage hollow (hollow body) au sol + 30 s de relevés en V", "30 s hollow rocks + 30 s V-ups", "30 s de hollow rocks + 30 s de V-ups"),
    "30 sec hollow rocks + 30 sec dead bug": F("30 s de gainage hollow (hollow body) au sol + 30 s de dead bug", "30 s hollow rocks + 30 s dead bug", "30 s de hollow rocks + 30 s de dead bug"),
    ...
    "15 reps tibialis + 60 sec planche + 30 sec side/côté": F("15 relevés de tibial antérieur + 60 s de planche + 30 s de planche latérale par côté", "15 tibialis raises + 60 s plank + 30 s side plank per side", "15 tibialis raises + 60 s de plancha + 30 s de plancha lateral por lado"),
    "15 tibialis/jambe + 60 sec planche": F("15 relevés de tibial antérieur par jambe + 60 s de planche", "15 tibialis raises per leg + 60 s plank", "15 tibialis raises por pierna + 60 s de plancha"),
    "15 tibialis/jambe + 60 sec planche + 30 sec side/côté": F("15 relevés de tibial antérieur par jambe + 60 s de planche + 30 s de planche latérale par côté", "15 tibialis raises per leg + 60 s plank + 30 s side plank per side", "15 tibialis raises por pierna + 60 s de plancha + 30 s de plancha lateral por lado"),
    ...
    "5 Nordic + 8 split squat/jambe DB 12 kg": F("5 Nordic + 8 fente bulgare par jambe, haltères 12 kg", "5 Nordic + 8 split squat per leg, 12 kg dumbbells", "5 Nordic + 8 split squat por pierna, mancuernas 12 kg"),
    "5 Nordic + 8 split squat/jambe DB 14 kg": F("5 Nordic + 8 fente bulgare par jambe, haltères 14 kg", "5 Nordic + 8 split squat per leg, 14 kg dumbbells", "5 Nordic + 8 split squat por pierna, mancuernas 14 kg"),
}
...
STRENGTH = {
    ...
    "5, 5, 5, 5+ AMRAP": F("5, 5, 5, 5+ AMRAP (max de répétitions)", "5, 5, 5, 5+ AMRAP", "5, 5, 5, 5+ AMRAP (máximo de reps)"),
    "5, 3, 1+ AMRAP": F("5, 3, 1+ AMRAP (max de répétitions)", "5, 3, 1+ AMRAP", "5, 3, 1+ AMRAP (máximo de reps)"),
    "3, 3, 3, 3+ AMRAP": F("3, 3, 3, 3+ AMRAP (max de répétitions)", "3, 3, 3, 3+ AMRAP", "3, 3, 3, 3+ AMRAP (máximo de reps)"),
    "5,6,8,AMRAP": F("5, 6, 8, AMRAP (max de répétitions)", "5, 6, 8, AMRAP", "5, 6, 8, AMRAP (máximo de reps)"),
    "3,5,6,AMRAP": F("3, 5, 6, AMRAP (max de répétitions)", "3, 5, 6, AMRAP", "3, 5, 6, AMRAP (máximo de reps)"),
    "AMRAP 1 set": F("AMRAP (max de répétitions) — 1 série", "AMRAP — 1 set", "AMRAP (máximo de reps) — 1 serie"),
...
TENNISFOOT = {
    ...
    "8 x 30 m sprint / recup 25 sec entre reps": F("8 × (30 m sprint + 25 s de récup entre répétitions)", "8 × (30 m sprint + 25 s rest between reps)", "8 × (30 m sprint + 25 s de recuperación entre reps)"),
    "6 x 30 m sprint / recup 25 sec entre reps": F("6 × (30 m sprint + 25 s de récup entre répétitions)", "6 × (30 m sprint + 25 s rest between reps)", "6 × (30 m sprint + 25 s de recuperación entre reps)"),
    "10 x 30 m sprint / recup 25 sec entre reps": F("10 × (30 m sprint + 25 s de récup entre répétitions)", "10 × (30 m sprint + 25 s rest between reps)", "10 × (30 m sprint + 25 s de recuperación entre reps)"),
    ...
    "1 set 6 jeux + 5 min récup entre sets": F("1 manche de 6 jeux + 5 min de récup entre manches", "1 set of 6 games + 5 min rest between sets", "1 set de 6 juegos + 5 min de recuperación entre sets"),
    ...
    "1 passage A/R chaque pattern": F("1 aller-retour par schéma", "1 round trip per pattern", "1 ida y vuelta por patrón"),
    ...
    "1 passage in-out": F("1 passage dedans-dehors", "1 in-out run", "1 pasada in-out"),
    ...
    "3 allers-retours 8 m de chaque pattern": F("3 allers-retours de 8 m par schéma", "3 round trips of 8 m per pattern", "3 idas y vueltas de 8 m por patrón"),
    ...
    "4 patterns": F("4 schémas", "4 patterns", "4 patrones"),
    "5 patterns": F("5 schémas", "5 patterns", "5 patrones"),
    ...
    "20 + 5 sec hold haut x 3": F("20 répétitions + tenue 5 s en haut × 3", "20 reps + 5 s hold at top × 3", "20 reps + 5 s en tensión arriba × 3"),
    "15 reps + tenu 30 sec": F("15 répétitions + tenue 30 s", "15 reps + 30 s hold", "15 reps + 30 s de tensión"),
    ...
    "10 reps chaque": F("10 répétitions chacun", "10 reps each", "10 reps cada uno"),
    "12 reps chaque": F("12 répétitions chacun", "12 reps each", "12 reps cada uno"),
    "12 par mouvement": F("12 par mouvement", "12 per movement", "12 por movimiento"),
    "8-10 reps contrôlées": F("8-10 répétitions contrôlées", "8-10 controlled reps", "8-10 reps controladas"),
    ...
    "10 par lettre / 10 par bras / 10 reps": F("10 par lettre / 10 par bras / 10 répétitions", "10 per letter / 10 per arm / 10 reps", "10 por letra / 10 por brazo / 10 reps"),
    "12 par lettre / 12 par bras": F("12 par lettre / 12 par bras", "12 per letter / 12 per arm", "12 por letra / 12 por brazo"),
    "12 par bras / 12 reps": F("12 par bras / 12 répétitions", "12 per arm / 12 reps", "12 por brazo / 12 reps"),
    ...
    "12 bridge + 10 bird-dog / côté": F("12 ponts fessiers + 10 bird-dog par côté", "12 bridge + 10 bird-dog per side", "12 bridge + 10 bird-dog por lado"),
    "12 bridge + 8 bird-dog / côté": F("12 ponts fessiers + 8 bird-dog par côté", "12 bridge + 8 bird-dog per side", "12 bridge + 8 bird-dog por lado"),
    "30 sec / jambe + 12 glute bridge bipodal": F("30 s par jambe + 12 ponts fessiers sur deux jambes", "30 s per leg + 12 two-legged glute bridge", "30 s por pierna + 12 glute bridge bipodal"),
    ...
    "5 min effectif/set": F("5 min effectif / série", "5 min effective / set", "5 min efectivos / set"),
    ...
    "match (60-150 min selon format 2 sets ou 3 sets gagnants)": F("match (60-150 min selon le format : 2 ou 3 manches gagnantes)", "match (60-150 min depending on format: best of 3 or 5 sets)", "partido (60-150 min según el formato: al mejor de 3 o 5 sets)"),
