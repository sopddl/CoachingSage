...
final class LegacyDoseMigrationTests: XCTestCase {
    ...
    func testMigrationTableMatchesBundledSwimmingDoses() async throws {
    ...
    func testMigrationTableMatchesBundledTennisDoses() async throws {
        try await assertMigrationMatches(sport: .tennis)
    }

    func testMigrationTableMatchesBundledFootballDoses() async throws {
        try await assertMigrationMatches(sport: .football)
    }
