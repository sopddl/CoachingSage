...
//   V1 (Story 1.1a) → V2 (Story 2.2) → V3 (Story 3.1) → V4 (Story 3.8) → V5 (Story 3.3b) → V6 (Story sœur post-3.3b)
//
...
// SchemaV1-V5 restent en historique git mais ne sont plus exposés au runtime.
import SwiftData
