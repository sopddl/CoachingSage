...
public enum Glossary {
    ...
    public static let entries: [GlossaryEntry] = [
        ...
        // Chantier yoga débutant pas assez didactique (2026-08-09) — postures individuelles
        // jamais glossariées (seuls les 8 termes génériques ci-dessus + catcow existaient) ;
        // les 35 postures/pranayama couvrant les templates beginner/hatha/vinyasa.
        GlossaryEntry(id: "yoga.tadasana",              titleKey: "glossary.tadasana.title",              definitionKey: "glossary.tadasana.definition",              sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.sukhasana",             titleKey: "glossary.sukhasana.title",             definitionKey: "glossary.sukhasana.definition",             sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.balasana",              titleKey: "glossary.balasana.title",              definitionKey: "glossary.balasana.definition",              sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.adhomukhasvanasana",    titleKey: "glossary.adhomukhasvanasana.title",    definitionKey: "glossary.adhomukhasvanasana.definition",    sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.adhomukhavrksasana",    titleKey: "glossary.adhomukhavrksasana.title",    definitionKey: "glossary.adhomukhavrksasana.definition",    sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.anjaneyasana",          titleKey: "glossary.anjaneyasana.title",          definitionKey: "glossary.anjaneyasana.definition",          sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.ardhachandrasana",      titleKey: "glossary.ardhachandrasana.title",      definitionKey: "glossary.ardhachandrasana.definition",      sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.ardhamatsyendrasana",   titleKey: "glossary.ardhamatsyendrasana.title",   definitionKey: "glossary.ardhamatsyendrasana.definition",   sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.ardhauttanasana",       titleKey: "glossary.ardhauttanasana.title",       definitionKey: "glossary.ardhauttanasana.definition",       sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.bakasana",              titleKey: "glossary.bakasana.title",              definitionKey: "glossary.bakasana.definition",              sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.bhujangasana",          titleKey: "glossary.bhujangasana.title",          definitionKey: "glossary.bhujangasana.definition",          sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.chaturangadandasana",   titleKey: "glossary.chaturangadandasana.title",   definitionKey: "glossary.chaturangadandasana.definition",   sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.dhanurasana",           titleKey: "glossary.dhanurasana.title",           definitionKey: "glossary.dhanurasana.definition",           sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.dirgha",                titleKey: "glossary.dirgha.title",                definitionKey: "glossary.dirgha.definition",                sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.garudasana",            titleKey: "glossary.garudasana.title",            definitionKey: "glossary.garudasana.definition",            sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.janusirsasana",         titleKey: "glossary.janusirsasana.title",         definitionKey: "glossary.janusirsasana.definition",         sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.nadishodhana",          titleKey: "glossary.nadishodhana.title",          definitionKey: "glossary.nadishodhana.definition",          sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.navasana",              titleKey: "glossary.navasana.title",              definitionKey: "glossary.navasana.definition",              sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.paschimottanasana",     titleKey: "glossary.paschimottanasana.title",     definitionKey: "glossary.paschimottanasana.definition",     sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.phalakasana",           titleKey: "glossary.phalakasana.title",           definitionKey: "glossary.phalakasana.definition",           sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.pinchamayurasana",      titleKey: "glossary.pinchamayurasana.title",      definitionKey: "glossary.pinchamayurasana.definition",      sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.salabhasana",           titleKey: "glossary.salabhasana.title",           definitionKey: "glossary.salabhasana.definition",           sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.salambabhujangasana",   titleKey: "glossary.salambabhujangasana.title",   definitionKey: "glossary.salambabhujangasana.definition",   sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.setubandha",            titleKey: "glossary.setubandha.title",            definitionKey: "glossary.setubandha.definition",            sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.sirsasana",             titleKey: "glossary.sirsasana.title",             definitionKey: "glossary.sirsasana.definition",             sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.suptabaddhakonasana",   titleKey: "glossary.suptabaddhakonasana.title",   definitionKey: "glossary.suptabaddhakonasana.definition",   sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.trikonasana",           titleKey: "glossary.trikonasana.title",           definitionKey: "glossary.trikonasana.definition",           sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.urdhvadhanurasana",     titleKey: "glossary.urdhvadhanurasana.title",     definitionKey: "glossary.urdhvadhanurasana.definition",     sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.ustrasana",             titleKey: "glossary.ustrasana.title",             definitionKey: "glossary.ustrasana.definition",             sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.utkatasana",            titleKey: "glossary.utkatasana.title",            definitionKey: "glossary.utkatasana.definition",            sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.uttanasana",            titleKey: "glossary.uttanasana.title",            definitionKey: "glossary.uttanasana.definition",            sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.utthitaparsvakonasana", titleKey: "glossary.utthitaparsvakonasana.title", definitionKey: "glossary.utthitaparsvakonasana.definition", sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.viparitakarani",        titleKey: "glossary.viparitakarani.title",        definitionKey: "glossary.viparitakarani.definition",        sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.virabhadrasana",        titleKey: "glossary.virabhadrasana.title",        definitionKey: "glossary.virabhadrasana.definition",        sportCodes: [Sport.yoga]),
        GlossaryEntry(id: "yoga.vrksasana",             titleKey: "glossary.vrksasana.title",             definitionKey: "glossary.vrksasana.definition",             sportCodes: [Sport.yoga]),
    ]
