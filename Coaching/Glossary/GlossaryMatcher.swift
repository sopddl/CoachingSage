...
extension Glossary {
    ...
    nonisolated(unsafe) static let detectionPatterns: [(pattern: String, id: String)] = [
        ...
        ("cat-cow", "catcow"),
        ("cat cow", "catcow"),
        // Chantier yoga débutant pas assez didactique (2026-08-09) — "chat-vache" (FR) et
        // "marjaryasana-bitilasana" (sanskrit) jamais détectés, seul l'anglicisme "cat-cow" l'était.
        ...
        ("work:rest", "hiit.workrest"),
        ("epoc", "hiit.epoc"),
        // Chantier yoga débutant pas assez didactique (2026-08-09) — 35 postures/pranayama
        // individuelles jamais détectées (seuls les termes génériques ci-dessus l'étaient).
        // Multi-mots d'abord (longest-first via sortedPatterns) pour éviter qu'un terme composé
        // ne soit tronqué par son sous-terme (ex. "adho mukha vrksasana" avant "vrksasana").
        ("adho mukha svanasana", "yoga.adhomukhasvanasana"),
        ("downward-facing dog", "yoga.adhomukhasvanasana"),
        ("downward facing dog", "yoga.adhomukhasvanasana"),
        ("down dog", "yoga.adhomukhasvanasana"),
        ("adho mukha vrksasana", "yoga.adhomukhavrksasana"),
        ("ardha chandrasana", "yoga.ardhachandrasana"),
        ("ardha matsyendrasana", "yoga.ardhamatsyendrasana"),
        ("ardha uttanasana", "yoga.ardhauttanasana"),
        ("chaturanga dandasana", "yoga.chaturangadandasana"),
        ("chaturanga", "yoga.chaturangadandasana"),
        ("janu sirsasana", "yoga.janusirsasana"),
        ("nadi shodhana", "yoga.nadishodhana"),
        ("pincha mayurasana", "yoga.pinchamayurasana"),
        ("salamba bhujangasana", "yoga.salambabhujangasana"),
        ("setu bandha sarvangasana", "yoga.setubandha"),
        ("setu bandhasana", "yoga.setubandha"),
        ("setu bandha", "yoga.setubandha"),
        ("supta baddha konasana", "yoga.suptabaddhakonasana"),
        ("utthita parsvakonasana", "yoga.utthitaparsvakonasana"),
        ("utthita trikonasana", "yoga.trikonasana"),
        ("urdhva dhanurasana", "yoga.urdhvadhanurasana"),
        ("viparita karani", "yoga.viparitakarani"),
        ("tadasana", "yoga.tadasana"),
        ("sukhasana", "yoga.sukhasana"),
        ("balasana", "yoga.balasana"),
        ("anjaneyasana", "yoga.anjaneyasana"),
        ("bakasana", "yoga.bakasana"),
        ("bhujangasana", "yoga.bhujangasana"),
        ("dhanurasana", "yoga.dhanurasana"),
        ("dirgha", "yoga.dirgha"),
        ("garudasana", "yoga.garudasana"),
        ("navasana", "yoga.navasana"),
        ("paschimottanasana", "yoga.paschimottanasana"),
        ("phalakasana", "yoga.phalakasana"),
        ("salabhasana", "yoga.salabhasana"),
        ("sirsasana", "yoga.sirsasana"),
        ("trikonasana", "yoga.trikonasana"),
        ("ustrasana", "yoga.ustrasana"),
        ("utkatasana", "yoga.utkatasana"),
        ("uttanasana", "yoga.uttanasana"),
        ("virabhadrasana", "yoga.virabhadrasana"),
        ("vrksasana", "yoga.vrksasana"),
